...
namespace Chunk
{
    ...
    std::vector<std::string> SplitText(const std::vector<std::string> & inputs, const int overlap, const int chunk_size);
    std::vector<std::string> SplitTextByCount(const std::vector<std::string> & inputs, const int overlap, const int count_threshold, std::shared_ptr<re2::RE2> regex);
}