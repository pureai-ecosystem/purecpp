...
class RagPureAIConan(ConanFile):
    ...
    options = {"shared": [True, False], "fPIC": [True, False], "CURL_STATIC_LINKING": [True, False]}
    default_options = {"shared": True, "fPIC": True, "CURL_STATIC_LINKING": False}
    ...
    def requirements(self):
        ...
        self.requires("onnxruntime/1.18.1", force=True)
